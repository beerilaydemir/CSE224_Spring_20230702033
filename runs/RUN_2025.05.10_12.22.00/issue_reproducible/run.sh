...
export PACKAGED_SCRIPT_3='openlane/designs/project2/src/alu.sdc';
export PACKAGED_SCRIPT_4='openlane/scripts/openroad/common/set_global_connections.tcl';
export PNR_SDC_FILE='openlane/designs/project2/src/alu.sdc';
export PROCESS_CORNER='nom';
export SAVE_LIB='./results/synthesis/alu.lib';
export SAVE_NETLIST='./out.v';
export SAVE_SDF='./results/synthesis/alu.sdf';
export SCRIPTS_DIR='openlane/scripts';
export SIGNOFF_SDC_FILE='openlane/designs/project2/src/alu.sdc';
