...
set env PACKAGED_SCRIPT_3 openlane/designs/project2/src/alu.sdc
set env PACKAGED_SCRIPT_4 openlane/scripts/openroad/common/set_global_connections.tcl
set env PNR_SDC_FILE openlane/designs/project2/src/alu.sdc
set env PROCESS_CORNER nom
set env SAVE_LIB ./results/synthesis/alu.lib
set env SAVE_NETLIST ./out.v
set env SAVE_SDF ./results/synthesis/alu.sdf
set env SCRIPTS_DIR openlane/scripts
set env SIGNOFF_SDC_FILE openlane/designs/project2/src/alu.sdc
