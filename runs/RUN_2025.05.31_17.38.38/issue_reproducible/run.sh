...
export CURRENT_NETLIST='./results/synthesis/TopModule.v';
...
export FP_PDN_VOFFSET='1.895';
export FP_PDN_VPITCH='3.795';
...
export SAVE_DEF='./results/floorplan/TopModule.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./results/floorplan/TopModule.odb';
